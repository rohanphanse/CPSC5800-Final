...
MODEL_PATHS = {
    ...
    "train5": "runs/detect/train5/weights/best.pt",
}
...
STAGING_ROOT = "eval_datasets_hand"
IMGSZ = 640
BATCH = 32
    ...
    with open(csv_path, newline="") as f:
        ...
        for row in reader:
            ...
            try:
                ...
                continue
            by_image[img_path].append((xmin, ymin, xmax, ymax, width, height))
    return by_image
...
def main():
    ...
    for model_name, model_path in MODEL_PATHS.items():
        ...
        for ds_name, _, yaml_path, _ in staged:
            ...
            summary.append((model_name, ds_name, metrics))
